...
public class IngredeintePlatilloDao {
    ...
    public List getAreaIngrediente() throws SQLException {
        ...
        try{
            ...
            ps = con.prepareStatement("SELECT * FROM ingredientePlatillo ORDER BY idAreaIngrediente");
            rs =ps.executeQuery();

            while(rs.next()){
                AreaIngrediente areaIngrediente = new AreaIngrediente();
                areaIngrediente.setIdArearIngrediente(rs.getInt(1));
            ...
            if(flag){
                ...
                try(ResultSet  generetadKeys = ps.getGeneratedKeys()){
                    if(generetadKeys.next()){
                        ...
                        areaIngredienteInsert.setIdArearIngrediente(idRecobery);
