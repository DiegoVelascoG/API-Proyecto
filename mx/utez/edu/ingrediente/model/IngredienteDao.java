...
import inventario.utez.edu.mx.Integradora.mx.utez.edu.areaIngrediente.model.AreaIngredienteDao;
...
public class IngredienteDao {
    ...
    public Ingrediente createIngrediente(Ingrediente ingrediente) throws SQLException{
        ...
        try{
            ...
            ps.setInt(2,ingrediente.getIdAreaIngrediente().getIdArearIngrediente());
